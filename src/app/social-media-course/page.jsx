...
const modules = [
  { 
    ...
    topics: ["Platform Algorithms", "Content Strategy", "Audience Research", "Competitor Analysis", "Profile Optimization"],
    image: "images/smf.jpg"
  },
  { 
    week: "3-4", 
    title: "Content Creation Mastery", 
    topics: ["Reels & Shorts Scripting", "Graphic Design Basics", "Video Recording Setup", "AI Content Tools", "Caption Writing"],
    image: "images/ccm.jpg"
  },
  { 
    week: "5-6", 
    title: "Platform Growth & Influencer", 
    topics: ["Instagram Growth", "YouTube SEO", "LinkedIn B2B", "Influencer Outreach", "UGC Campaigns"],
    image: "images/ifg.jpg"
  },
  { 
    week: "7-8", 
    title: "Analytics & Monetization", 
    topics: ["Social Media Analytics", "ROI Tracking", "Client Acquisition", "Freelancing", "Portfolio Building"],
    image: "images/am.jpg"
  },
];
  ...
  return (
    <div className="min-h-screen pt-24 sm:pt-28 lg:pt-32 pb-10 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 sm:mb-14">
        <Chip variant="cyan" className="mb-4 sm:mb-6">8 Weeks Program</Chip>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }} className="mb-10 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
        {[{ v: "8", l: "Weeks" }, { v: "16+", l: "Sessions" }, { v: "4+", l: "Projects" }, { v: "Certificate", l: "Recognized" }].map((s, i) => (
          <div key={i} className="rounded-xl border border-border-light bg-white p-3 text-center shadow-card-soft sm:p-4">
            <p className="text-xl font-bold text-cyan-accent sm:text-2xl">
